#!/usr/bin/env bash
# =============================================================================
# app/listener_nodelet/make.sh — 接收端独立软件包（无 catkin）
# -----------------------------------------------------------------------------
#   ./make.sh x86       编译 liblistener_nodelet.so → build/
...
SO_NAME="liblistener_nodelet.so"
...
cmd_x86() {
  prepare_env
  echo "==== listener_nodelet x86 build ===="
  mkdir -p "${BUILD}"
